...
function VendorSidebar({ collapsed, settingData }) {
  ...
  const getCurrentMenuKey = (path) => {
    if (path === "/vendor/wallet")
      return { selected: "wallet", open: "business" };
    if (path === "/vendor/wallet/history")
      return { selected: "wallet_history", open: "business" };
        ...
        <Avatar
          ...
          src={
            <img
              src={
                settingData?.logo
                  ? `${BASE_URL}/${settingData.logo}`
                  : "/positive_milk_logo.png"
              }
              alt="avatar"
            />
          }
