...
const AddBannerModel = ({ isModalOpen, handleOk, handleCancel }) => {
  ...
  const foodSections = [
    { value: 'homeMilk', label: 'Home (Milk)' },
    { value: 'offerMilk', label: 'Offer (Milk)' },
    // { value: 'b1g1Milk', label: 'Buy 1 Get 1 Free (Food)' },
  ...
  return (
    ...
    >
      <Form form={form} name="addBanner" onFinish={onFinish} layout="vertical">
        <Form.Item
          label="Banner Title"
          name="title"
        ...
        <Form.Item label="Banner Image" required>
          <ImgCrop rotationSlider aspect={320 / 150} quality={1} modalTitle="Crop your banner">
            <Upload
