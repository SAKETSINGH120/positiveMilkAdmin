...
const OrderDetails = () => {
  ...
  const columns = [
    ...
    { title: 'Quantity', dataIndex: 'quantity', key: 'quantity', align: 'center' },
    {
      ...
      key: 'price',
      align: 'center',
      render: (_, record) => `₹${record.product_id.vendorSellingPrice}`,
    },
    {
      title: 'Total',
      key: 'total',
  ...
  return (
    <Card className="max-w-xl mx-auto my-4 shadow-md rounded-xl border p-6">
      ...
      <Row>
        {/* <Col span={12}>
          <div className="my-4">
            ...
            <Text>Shop Name: {orderData.shopId.name}</Text>
            <br />
        ...
        <Col span={12}>
          <div className="my-4">
            ...
            <Text>Vendor Name: {orderData.vendorId.name}</Text>
            <br />
      ...
      <div className="my-4">
        ...
        <Text>Method: {orderData.paymentMode}</Text>
        <br />
        <Text>Status: {orderData.paymentStatus}</Text>
        <br />
        <Text>Total: ₹ {orderData.finalTotalPrice}</Text>
        <br />
