...
const AppDownload = () => {
  return (
    <section
      id="download"
      className="relative overflow-hidden bg-gradient-to-br from-green-700 via-green-800 to-green-900 py-28"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="text-center lg:text-left">
              ...
              >
                Join millions of satisfied users enjoying instant delivery,
                exclusive offers, and seamless grocery shopping.
              </motion.p>
